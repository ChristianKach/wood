 $(document).ready(function() {
    ...
    $('.btn_delete').click(function(e) {
        e.preventDefault();
        var coefficient_flexion_simple_id = $(this).attr('data-id');
        var re = confirm('Êtes vous sûr de vouloir supprimer ce coefficient?');
        if(re) {
          window.location.href = site_url + 'coefficient_flexion_simple/delete/' + coefficient_flexion_simple_id;
        }
    });
    ...
    $('#btn_delete_many').click(function(e) {
        ...
        if(re) {
            ...
            var form = document.createElement("form");
                ...
                form.setAttribute("action", site_url + 'coefficient_flexion_simple/delete-many');
