<div class="right_col" role="main">
          <div class="">
            <div class="page-title"><br><br>
              <div class="title_center">
                <center><h3 style="color:red">COMPRESSION AXIAL</h3></center>
              </div>
            </div> <br><br>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <?php if(!isset($compression)) { ?>
                  <form id="compression" method="post" action="<?php echo site_url('compression/save'); ?>" data-parsley-validate 
                    class="form-horizontal form-label-left">
                    <?php } else { ?>
                    <form id="compression" 
                        method="post" action="<?php echo site_url('compression/update') . '/' . $compression_id = (int) $this->uri->segment(3); ?>" data-parsley-validate 
                      class="form-horizontal form-label-left">
                    <?php } ?>
                  <div class="row">
                  <div class="col-md-6 col-xs-12">
                    <div class="x_panel">
                      ...
                      <div class="form-group">
                        ...
                        <?php echo form_error('compression', '<span style="color: red;">', '</span>'); ?>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" value="<?php echo set_value('libelle');
                          if(isset($compression)) echo $compression->libelle; ?>" class="form-control" placeholder=" nom du projet" id="libelle" name="libelle" required="riquired">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          ...
                          if(isset($compression)) echo $compression->taux_emb_ar; ?>" class="form-control" placeholder="en pourcentage % " id="taux_emb_ar" name="taux_emb_ar" required="riquired">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          ...
                          if(isset($compression)) echo $compression->tr_emb_ar; ?>" class="form-control" id="tr_emb_ar" name="tr_emb_ar" required="riquired" placeholder="Durée de résistance (Tr) en min">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          ...
                          if(isset($compression)) echo $compression->tpr_emb_ar; ?>" class="form-control" id="tpr_emb_ar" name="tpr_emb_ar" required="riquired" placeholder="Temps de protection (Tpr) en min">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" style="color: #a77d46;">Flambement m</label>
                        <?php echo form_error('compression', '<span style="color: red;">', '</span>'); ?>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="number" value="<?php echo set_value('m');
                          if(isset($compression)) echo $compression->m; ?>" class="form-control" id="m" name="m" required="riquired" placeholder="Coefficient definissant la longueur de flambement  m">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          ...
                          if(isset($compression)) echo $compression->face_emb_ar; ?>" class="form-control" id="face_emb_ar" name="face_emb_ar" required="riquired" placeholder="Face exposée au feu">
                        </div>
                      </div>
                  </div>
                </div>
              ...
              <div class="col-md-6 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2 style="color:#20804b"><b>Section</b> </h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          ...
                          if(isset($compression)) echo $compression->lar_p; ?>" class="form-control" id="lar_p" name="lar_p" required="riquired" placeholder="Largeur du poteau en mm">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          ...
                          if(isset($compression)) echo $compression->long_p; ?>" class="form-control" id="long_p" name="long_p" required="riquired" placeholder="Longueur du poteau en mm">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          ...
                          if(isset($compression)) echo $compression->haut_p; ?>" class="form-control" id="haut_p" name="haut_p" required="riquired" placeholder="Hauteur du poteau en mm">
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="x_content">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          ...
                          if(isset($compression)) echo $compression->fd_emb_ar; ?>" class="form-control" id="fd_emb_ar" name="fd_emb_ar" required="riquired" placeholder="Effort Normal dans l'arbaletrier (en N)">
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <?php if(isset($compression)) { ?>
                    <input type="hidden" name="compression_id" value="<?php echo $compression->compression_id; ?>" />
                <?php } ?>
    ...
    <div class="row">
              <div class="col-md-12 col-xs-12">
                  <div class="x_panel">
                  <div class="x_title">
                    <center><h3 style="color:red">COMPRESSION</h3></center>
                    <ul class="nav navbar-right panel_toolbox">
                  ...
                  <div class="x_content">
                    ...
                    <table id="table_data" aria-describedby="datatable_info" role="grid" class="table table-striped table-bordered dataTable no-footer">
                      ...
                      <tbody>
                          ...
                          <?php foreach($compressions as $p) { ?>       
                      <tr>
                          <td>
                             
                            <input type="checkbox" class="check_item" value="<?php echo $p->compression_id; ?>">
                          ...
                          <td>
                           <center>
                            <a href="<?php echo site_url(); ?>compression/update/<?php echo $p->compression_id; ?>"  
                            class="btn btn-info btn-xs"><i class="fa fa-pencil"></i></a>
                            <a href="#" data-id="<?php echo $p->compression_id; ?>" class="btn btn-danger btn-xs btn_delete"><i class="fa fa-trash-o"></i></a>
                            <a href="<?php echo site_url(); ?>resultat/compression/<?php echo $p->compression_id; ?>"  
