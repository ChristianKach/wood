...
class Programme extends MY_Controller {
    ...
    public function save() {
        ...
        if ($this->form_validation->run()) {
           ...
           if($programme_id && isset($_POST['adherant_ids']) && !empty($_POST['adherant_ids'])) {
               $data_adherant_programme['programme_id'] = $programme_id;

               $adherant_ids = $this->input->post('adherant_ids');

               foreach($adherant_ids as $adherant_id) {
                   $data_adherant_programme['adherant_id'] = $adherant_id;
                   $this->model_programme_adherant->save($data_adherant_programme);
               }
           }
    ...
    public function update() {
        ...
        if(isset($_POST['programme_id'])) {
            ...
            if ($this->form_validation->run()) {
               ...
               $this->model_programme->update($programme_id, $data);

               if($programme_id && isset($_POST['adherant_ids']) && !empty($_POST['adherant_ids'])) {
                   $data_adherant_programme['programme_id'] = $programme_id;
                   
                   $this->model_programme_adherant->deleteAllByProgrammeId($programme_id);
                   $adherant_ids = $this->input->post('adherant_ids');
        ...
        $data['programme_adherants'] = $this->model_programme_adherant->getAllAdherantsByProgrammeId($programme_id);
