          ...
          <div class="">
            <div class="page-title"><br><br>
              <div class="title_center">
                <center><h3 >Résultat du Projet : <?php  echo "<b style=color:red;>".ucfirst($emb_doubles->libelle)."</b>"; ?> <br><br>   
                  Note de calcul de Bois: 
                  <?php 
                    if($emb_doubles) { 
                                  echo "<b style=color:red;>"."Embrevement Double"."</b>";
                                 } else {
                                  echo '';
                                 }
                                  ?>
              ...
              <?php foreach($emb_double as $p) { 
                          ...
                          $emb_double = $this->model_emb_double->getById($p->emb_double_id);
                          $pc = ($I *($emb_double[0]->tr_emb_ar - $emb_double[0]->tpr_emb_ar)) + (1*7);
                          $en = ($I *$emb_double[0]->fd_emb_ar);
                          $lsi = $emb_double[0]->lent_emb_ar - ($emb_double[0]->face_emb_ar * $pc);
                          $hsi = $emb_double[0]->haut_emb_ar - ($emb_double[0]->face_emb_ar * $pc);
                          $Lsi = $emb_double[0]->barb_emb_ar - ($emb_double[0]->face_emb_ar * $pc);
                          $Hsi = $emb_double[0]->harb_emb_ar - ($emb_double[0]->face_emb_ar * $pc);                       
                          $angle = $emb_double[0]->angle_emb_ar;               
                          $Ltal = $emb_double[0]->ltal_emb_ar - $pc ;
                          $Htal = $emb_double[0]->htal_emb_ar - $pc ;
                          ...
                          //$Pc = ($I * ($emb_double[0]->tr_emb_ar-));
                          $Ensi = $I * $emb_double[0]->fd_emb_ar;
                          $Cem = ($emb_double[0]->lf_emb_ar * sqrt(12)/$Lsi);
                          ...
                          $Rcas = ($Rc * $H);
                          $Cca = (($Ensi * cos(($angle) *(3.14159/180))/($lsi * $Leco)));
                          $Rcp = (($Rco * $H));
            ...
            <div class="row">
              ...
              <?php if ($Vct > 100 || $Vco  > 100 || $Vte > 100 || $Vten > 100 || $Vca > 100){
               ?>
                  ...
                  <div class="x_content">
                    ...
                    <table class="table table-striped jambo_table bulk_action" >
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>Effort normal de l'arbaletrier en situation incendie</td>
                          <td>
                            <?php
                                 if($emb_double) { 
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <center>
                <a href="<?php echo site_url(); ?>emb_double/update/<?php echo $p->emb_double_id; ?>"class="btn btn-success"><i class="fa fa-pencil"></i> Modifier</a>
                <a href="<?php echo site_url('emb_double'); ?>" data-id="" class=" btn btn-primary"><i class="fa fa-reply"></i> Retour</a>
