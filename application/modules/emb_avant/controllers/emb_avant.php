...
class Emb_avant extends MY_Controller {
    ...
    public function save() {
        ...
        if ($this->form_validation->run()) {
           ...
           $this->session->set_flashdata('add', 'Embrèvement Avant enregistré!'); 
    ...
    public function update() {
      if(!$emb_avant_id = (int) $this->uri->segment(3)) {
        ...
        if ($this->form_validation->run()) {
           ...
           $this->session->set_flashdata('update', 'Embrevement avant mis à jour!'); 
           redirect('resultat/emb_avant');
    ...
    public function delete() {
        ...
        try {
            ...
            $this->session->set_flashdata('delete', 'Embrèvement Avant supprimé!');
        } catch(Exception $e) {
            redirect('emb_avant');
        }
