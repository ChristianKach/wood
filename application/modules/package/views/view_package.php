              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <?php } else { ?>
                        <h2>Mise à jour: <?php echo $package->package_libelle; ?></h2>
                    <?php } ?>
                  ...
                  <div class="x_content row">
                    ...
                    <?php if(!isset($package)) { ?>
                        <form id="form_package" method="post" action="<?php echo site_url('package/save'); ?>" data-parsley-validate 
                          class="form-horizontal form-label-left">
                    <?php } else { ?>
                        <form id="form_package" 
                        method="post" action="<?php echo site_url('package/update') . '/' . $adherant_id = (int) $this->uri->segment(3); ?>" data-parsley-validate 
                      class="form-horizontal form-label-left">
                    <?php } ?>
                      ...
                      <div class="form-group col-md-5">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="package_libelle">
                         Package libellé <span class="required">*</span> 
                        </label>
                        <?php echo form_error('package_libelle', '<span style="color: red;">', '</span>'); ?>
                        <div class="col-md-8 col-sm-8 col-xs-12">
                          <input type="text" 
                          value="<?php
                           if(isset($package)) echo $package->package_libelle; ?>" 
                           placeholder="Libellé" name="package_libelle" id="package_libelle" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div class="form-group col-md-5">
                        <div class="col-md-8 col-sm-8 col-xs-12 col-md-offset-3">
                          <button type="button" onclick="document.getElementById('form_package').reset();" class="btn btn-primary">Annuler</button>
                    ...
                    <table id="table_data" aria-describedby="datatable_info" role="grid" class="table table-striped table-bordered dataTable no-footer">
                      ...
                      <tr>
                          <td>
                                  ...
                                  <input type="checkbox" class="check_item" value="<?php echo $p->package_id; ?>">
                          ...
                          <td><?php echo truncate($p->package_libelle, 20); ?></td>
                          <td>
                           <center>
                            <a href="<?php echo site_url(); ?>package/update/<?php echo $p->package_id; ?>"  
                            class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Modifier</a>
                            <a href="#" data-id="<?php echo $p->package_id; ?>" class="btn btn-danger btn-xs btn_delete"><i class="fa fa-trash-o"></i> Supprimer</a>
                           </center>
                          </td>
                      </tr>
                          <?php } ?>
