          ...
          <div class="">
            <div class="page-title"><br><br>
              <div class="title_center">
                <center><h3 style="color:red">POINCON CONTRE-FICHE</h3></center>
              </div>
            </div> <br><br>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <?php if(!isset($poincon)) { ?>
                  <form id="poincon" method="post" action="<?php echo site_url('poincon/save'); ?>" data-parsley-validate 
                    class="form-horizontal form-label-left">
                    <?php } else { ?>
                    <form id="poincon" 
                        method="post" action="<?php echo site_url('poincon/update') . '/' . $poincon_id = (int) $this->uri->segment(3); ?>" data-parsley-validate 
                      class="form-horizontal form-label-left">
                    <?php } ?>
                  <div class="row">
                  <div class="col-md-6 col-xs-12">
                    <div class="x_panel">
                      ...
                      <div class="form-group">
                        ...
                        <?php echo form_error('poincon', '<span style="color: red;">', '</span>'); ?>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" value="<?php echo set_value('libelle');
                          if(isset($poincon)) echo $poincon->libelle; ?>" class="form-control" placeholder=" nom du projet" id="libelle" name="libelle" required="riquired">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          ...
                          if(isset($poincon)) echo $poincon->angle_emb_ar; ?>" placeholder="angle α" id="angle_emb_ar" name="angle_emb_ar" required="required">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          ...
                          if(isset($poincon)) echo $poincon->taux_emb_ar; ?>" class="form-control" placeholder="en pourcentage %" id="taux_emb_ar" name="taux_emb_ar" required="riquired">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          ...
                          if(isset($poincon)) echo $poincon->classe_emb_ar; ?>" class="form-control" id="classe_emb_ar" name="classe_emb_ar" required="riquired" placeholder="Classe de service">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          ...
                          if(isset($poincon)) echo $poincon->tr_emb_ar; ?>" class="form-control" id="tr_emb_ar" name="tr_emb_ar" required="riquired" placeholder="Durée de résistance (Tr) en min">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          ...
                          if(isset($poincon)) echo $poincon->tpr_emb_ar; ?>" class="form-control" id="tpr_emb_ar" name="tpr_emb_ar" required="riquired" placeholder="Temps de protection (Tpr) en min">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          ...
                          if(isset($poincon)) echo $poincon->face_emb_ar; ?>" class="form-control" id="face_emb_ar" name="face_emb_ar" required="riquired" placeholder="Face exposée au feu">
                        </div>
                      </div>
                  </div>
                </div>
              ...
              <div class="col-md-6 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2 style="color:#20804b"><b>Contrefiche</b> </h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          ...
                          if(isset($poincon)) echo $poincon->lent_emb_ar; ?>" class="form-control" id="lent_emb_ar" name="lent_emb_ar" required="riquired" placeholder="Largeur de contrefiche en mm">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          ...
                          if(isset($poincon)) echo $poincon->haut_emb_ar; ?>" class="form-control" id="haut_emb_ar" name="haut_emb_ar" required="riquired" placeholder="Hauteur de contrefiche en mm">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          ...
                          if(isset($poincon)) echo $poincon->htal_emb_ar; ?>" class="form-control" id="htal_emb_ar" name="htal_emb_ar" required="riquired" placeholder="Hauteur du talon/Profondeur en mm">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          ...
                          if(isset($poincon)) echo $poincon->ltal_emb_ar; ?>" class="form-control" id="ltal_emb_ar" name="ltal_emb_ar" required="riquired" placeholder="Longueur du talon en mm">
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="x_panel">
                  <div class="x_title">
                    <h2 style="color:#20804b"><b>Poinçon</b> </h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          ...
                          if(isset($poincon)) echo $poincon->barb_emb_ar; ?>" class="form-control" id="barb_emb_ar" name="barb_emb_ar" required="riquired" placeholder="Largeur de poinçon en mm">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          ...
                          if(isset($poincon)) echo $poincon->harb_emb_ar; ?>" class="form-control" id="harb_emb_ar" name="harb_emb_ar" required="riquired" placeholder="Hauteur de poinçon en mm">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          ...
                          if(isset($poincon)) echo $poincon->lf_emb_ar; ?>" class="form-control" id="lf_emb_ar" name="lf_emb_ar" required="riquired" placeholder="Longueur de flambement en mm">
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="x_content">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          ...
                          if(isset($poincon)) echo $poincon->fd_emb_ar; ?>" class="form-control" id="fd_emb_ar" name="fd_emb_ar" required="riquired" placeholder="Effort Normal dans l'arbaletrier en N">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          ...
                          if(isset($poincon)) echo $poincon->ft_emb_ar; ?>" class="form-control" id="ft_emb_ar" name="ft_emb_ar" required="riquired" placeholder="Effort Normal dans l'entrait en N">
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <?php if(isset($poincon)) { ?>
                    <input type="hidden" name="poincon_id" value="<?php echo $poincon->poincon_id; ?>" />
                <?php } ?>
                  ...
                  <div class="x_content">
                    ...
                    <table id="table_data" aria-describedby="datatable_info" role="grid" class="table table-striped table-bordered dataTable no-footer">
                      ...
                      <tbody>
                          ...
                          <?php foreach($poincons as $p) { ?>       
                      <tr>
                          <td>
                             
                            <input type="checkbox" class="check_item" value="<?php echo $p->poincon_id; ?>">
                          ...
                          <td>
                           <center>
                            <a href="<?php echo site_url(); ?>poincon/update/<?php echo $p->poincon_id; ?>"  
                            class="btn btn-info btn-xs"><i class="fa fa-pencil"></i></a>
                            <a href="#" data-id="<?php echo $p->poincon_id; ?>" class="btn btn-danger btn-xs btn_delete"><i class="fa fa-trash-o"></i></a>
                            <a href="<?php echo site_url(); ?>resultat/poincon/<?php echo $p->poincon_id; ?>"  
